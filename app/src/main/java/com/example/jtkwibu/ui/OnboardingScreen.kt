...
val pages = listOf(
    OnboardingPage("Welcome", "Explore anime!", R.drawable.page1),
    OnboardingPage("Search", "Find your favorites!", R.drawable.page2),
    OnboardingPage("Profile", "Make it yours!", R.drawable.page3)
)
